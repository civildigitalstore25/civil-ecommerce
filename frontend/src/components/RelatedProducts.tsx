  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
      {related.slice(0, limit).map((product) => (
        <div
          key={product._id}
          className="rounded-2xl overflow-hidden transition-colors duration-200 cursor-pointer shadow-lg min-h-[280px] md:min-h-[320px] lg:min-h-[350px] flex flex-col"
          style={{
        ...
        >
          ...
          <div className="p-3 md:p-4 flex flex-col flex-1 justify-between">
            <h4
              className="font-bold text-sm md:text-base lg:text-lg text-center line-clamp-2 mb-2"
            ...
            <Button
              variant="primary"
              className="!py-2 !px-4 md:!px-6 !rounded-xl !text-xs md:!text-sm font-semibold shadow-none mt-auto"
              style={{
