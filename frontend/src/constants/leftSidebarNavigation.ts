...
export const leftSidebarNavigationCategories: LeftSidebarCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: "coreldraw-files", name: "Coreldraw Files", href: "/category?brand=projects&category=coreldraw-files" },
      { id: "sketchup-files", name: "SketchUp Files", href: "/category?brand=projects&category=sketchup-files" },
      { id: "vray-files", name: "Vray Files", href: "/category?brand=projects&category=vray-files" },
