        ...
        <article className="mb-16">
          ...
          <header className="mb-10">
            ...
            {typeof blog.viewCount === "number" && blog.viewCount > 0 && (
              <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-gray-200 bg-gray-50 text-sm text-gray-600">
                <Eye className="w-4 h-4 text-blue-600" aria-hidden />
                <span className="font-semibold text-gray-900">
                  {blog.viewCount.toLocaleString()}
                </span>
                <span className="text-gray-500">
                  {blog.viewCount === 1 ? "Total view" : "Total views"}
                </span>
              </div>
            )}
          </header>
