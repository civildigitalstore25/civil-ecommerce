...
import { BackInStockNotifyForm } from "./BackInStockNotifyForm";
  ...
  onSiteEnquiry,
    ...
    return (
      <div ref={actionRef} className="mt-4">
        ...
        {isOutOfStock && outOfStockProduct ? (
          <BackInStockNotifyForm
            productId={outOfStockProduct.productId}
            productName={outOfStockProduct.productName}
          />
        ) : isOutOfStock ? (
          <div
            className="w-full rounded-lg border-2 py-4 text-center text-lg font-bold"
            style={{
