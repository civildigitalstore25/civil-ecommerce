...
export function AddProductModalDealEbookPricing({ colors, newProduct, setNewProduct }: Props) {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              setNewProduct((prev) => ({ ...prev, dealEbookPriceINR: e.target.value }))
            }
            placeholder="0.00"
            step="0.01"
            min="0"
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              setNewProduct((prev) => ({ ...prev, dealEbookPriceUSD: e.target.value }))
            }
            placeholder="0.00"
            step="0.01"
            min="0"
