...
export function AddProductModalDealSubscriptionDurationsPricing({
  colors,
  newProduct,
  setNewProduct,
}: Props) {
  if (newProduct.brand === "ebook" || newProduct.subscriptionDurations.length === 0) return null;
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setNewProduct((prev) => ({ ...prev, dealSubscriptionDurations: updatedDeals }));
                }}
                placeholder="0.00"
                step="0.01"
                min="0"
