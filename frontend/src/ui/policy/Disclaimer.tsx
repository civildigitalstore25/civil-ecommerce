        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-semibold mb-3" style={{ color: colors.text.primary }}>1. External Links Disclaimer</h3>
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-semibold mb-3" style={{ color: colors.text.primary }}>2. Professional Disclaimer</h3>
                <p className="leading-relaxed" style={{ color: colors.text.secondary }}>
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-semibold mb-3" style={{ color: colors.text.primary }}>3. Limitation of Liability</h3>
                <p className="leading-relaxed" style={{ color: colors.text.secondary }}>
