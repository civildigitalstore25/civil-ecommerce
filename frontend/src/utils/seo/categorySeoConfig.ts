...
> = {
  autocad: {
    name: "AutoCAD",
    keywords:
      "autocad license, autocad software, 2D CAD, 3D CAD, architectural drafting",
    description:
      "AutoCAD software for professional 2D and 3D CAD design and drafting",
  },
  "3ds-max": {
    name: "3ds Max",
  ...
  "aec-collection": {
    ...
    description:
      "Autodesk AEC Collection for architecture, engineering and construction",
  },
  "microsoft-365": {
    name: "Microsoft 365",
  ...
  "structural-softwares": {
    ...
    keywords:
      "structural analysis software, engineering software, building design",
